...
public class SetPasswordActivity extends BaseProtocolActivity implements View.OnClickListener {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        InputUtil.hideInputMethdView(SetPasswordActivity.this, etPass);
        InputUtil.hideInputMethdView(SetPasswordActivity.this, etPhone);
    ...
    public void onTaskSuccess(BaseModel result) {
        if (RQ_CHECK_CODE.equals(result.getRequest_code())) {
            ...
            startActivity(NewPasswordActivity.class, map);
        }
    }
