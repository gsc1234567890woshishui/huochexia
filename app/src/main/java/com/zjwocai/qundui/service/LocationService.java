...
public class LocationService extends Service implements ProcotolCallBack ,RequestCodeSet {
    ...
    private void resetOption() {
       ...
       // if (!TextUtils.isEmpty(strInterval)) {
           // try{
                ...
                locationOption.setInterval(1800000);
    ...
    private void executeNetListen(final AMapLocation loc) {
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                System.out.println("service11111111111111111111111111111111111111111"+longitude);
                System.out.println("service11111111111111111111111111111111111111111"+latitude);
            }
        }, 7000);
    }
    //请求服务器，提交定位数据
    private void requestServer(AMapLocation loc) {
        ProtocolBill.getInstance().track(this, this,id,String.valueOf(loc.getLongitude()),String.valueOf(loc.getLatitude()),"1");
    }

//    private void requestNet(final AMapLocation loc){
