package com.zjwocai.qundui.widgets.placeview;
...
import com.zjwocai.qundui.widgets.placeview.adapter.NumericWheelAdapter;
...
//	private WheelView wv_mins;
    ...
    private Type type;
    private static int START_YEAR = 1930, END_YEAR = 2050;
    ...
    public boolean isE() {
        if (wv_year.isEnabled() && wv_month.isEnabled() && wv_day.isEnabled())
            return true;
        else return false;
    }
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setLabel(context.getString(R.string.pickerview_year), "2015");// 添加文字

        // 月
        wv_month = (WheelView) view.findViewById(R.id.wv_month);
        wv_month.setAdapter(new NumericWheelAdapter(1, 12));
        wv_month.setLabel(context.getString(R.string.pickerview_month), "12");
        ...
        wv_day.setLabel(context.getString(R.string.pickerview_day), "30");
        ...
        wv_year.setWv(wv_month, wv_day);
        wv_month.setWv(wv_year, wv_day);
        wv_day.setWv(wv_year, wv_month);
...
//		wv_mins.setTextSize(textSize);
    ...
    public String getTime() {
        ...
        return DateUtil.format(sb.toString(), "yyyy-M-d", "yyyy-MM-dd");
    }
