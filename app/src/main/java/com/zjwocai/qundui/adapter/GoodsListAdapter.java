 ...
 */
public class GoodsListAdapter extends BaseListAdapter {

    private boolean flag = false;
    public GoodsListAdapter(BaseActivity context, List list, boolean flag) {
...
//    }
    ...
    protected GoodsListAdapter(BaseActivity context, List list, int defaultId, int radius) {
        super(context, list, defaultId, radius);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        OrderModel model = (OrderModel) mList.get(position);
        if (model.getStatus().equals("1")){
            ...
            holder.ivState.setImageResource(R.drawable.sign_delivered);
        }
